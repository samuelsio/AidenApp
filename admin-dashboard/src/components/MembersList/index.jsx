              ...
              <div className="col-md-8">
                <div className="card bg-secondary text-white p-2">
                    <div className="MembersList d-flex w-100 align-items-center justify-content-evenly">
                        ...
                        <p className={`card  text-white bg-primary p-3 m-0 rounded w-25 ${selectedFilter === 'username' ? 'selected' : ''}`} onClick={() => sortTable('username')}>Username</p>
                        <p className={`card  text-white bg-primary p-3 m-0 rounded w-25 ${selectedFilter === 'displayName' ? 'selected' : ''}`} onClick={() => sortTable("displayName")}>Display Name</p>
                        <p className={`card  text-white bg-primary p-3 m-0 rounded w-25 ${selectedFilter === 'created' ? 'selected' : ''}`} onClick={() => sortTable('created')}>Date Created</p>
